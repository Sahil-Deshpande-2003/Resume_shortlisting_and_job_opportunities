...
# job_descriptions.append(naukri1.naukri1)

# job_descriptions = naukri1.get_job_data("python developer")

def get_job_description(search_query):
    return naukri1.get_job_data("python, c, c++")
